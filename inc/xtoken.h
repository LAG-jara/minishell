...
/*   Updated: 2023/10/29 13:05:48 by glajara-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_lst	*xtok_addc(t_lst **xtok, char c, int x_flag, int q_flag);
t_lst	*xtok_adds(t_lst **xtok, char *c, int x_flag, int q_flag);
